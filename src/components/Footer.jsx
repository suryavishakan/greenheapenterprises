        ...
        <div className="px-4 mx-auto sm:px-6 lg:px-8 max-w-7xl">
            <div className="grid grid-cols-2 md:col-span-3 lg:grid-cols-6 gap-y-16 gap-x-12">
                <div className="col-span-2 md:col-span-3 lg:col-span-2 lg:pr-8">
                    <img className="w-auto h-16 bg-cover" src={logo} alt="logo" />

                    <p className="text-base leading-relaxed text-gray-600 mt-7">Connecting you to trusted solutions in food, real estate, and gold investment—all under one roof.</p>
            ...
            <p className="text-sm text-center text-gray-600">© Copyright 2025, All Rights Reserved by Greenheap</p>
        </div>
    </section>
