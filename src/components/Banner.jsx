...
const Banner = () => {
  return (
    <section className="relative lg:min-h-[1000px] pt-24 pb-10 sm:pt-32 sm:pb-16 lg:pb-24 overflow-hidden">
        <div className="px-4 mx-auto max-w-7xl sm:px-6 lg:px-8 relative z-20">
          <div className="max-w-2xl mx-auto text-center">
            <h1 className="text-4xl font-bold sm:text-5xl">
              <span className="text-transparent bg-clip-text bg-gradient-to-r from-green-300 to-white">
                Building Dreams, Investing in Futures, Savoring Flavor
              </span>
            </h1>
            <p className="mt-5 text-base text-white sm:text-xl">
             From authentic tastes to secure financial growth and real estate development, we’re paving the way for a prosperous future.
            </p>
            ...
            <Link
              ...
              smooth={true}
              duration={500}
              aria-label="Explore Greenheap services"
            ...
            <div className="grid grid-cols-1 px-20 mt-12 text-left gap-x-12 gap-y-8 sm:grid-cols-3 sm:px-0">
              <div className="flex items-center">
                ...
                <p className="ml-3 text-sm text-white">Over 12,000 customers</p>
              </div>
              ...
              <div className="flex items-center">
                ...
                <p className="ml-3 text-sm text-white">Join us, get maximum benefits</p>
              </div>
        ...
        {/* Image: normal flow on mobile, absolute on md+ */}
        <div
          className=""
        >
          ...
          <img
            loading='lazy'
            className="block md:hidden w-full mx-auto mt-5"
            src={bannerMobile}
            alt="Credit cards"
          />
        </div>
